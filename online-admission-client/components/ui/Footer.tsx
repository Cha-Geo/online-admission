...
const Footer = () => {
  return (
    <footer className="bg-white bg-opacity-70">
      <div className="container px-6 py-8 gap-y-10">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-3 lg:mx-14 xl:mx-20">
        ...
        <p className="font-sans py-8 text-start sm:text-center md:text-lg md:p-4  ">
          ...
          <span className="font-normal opacity-100">
            Alpha University. All rights reserved.
          </span>
        </p>
      </div>
    </footer>
