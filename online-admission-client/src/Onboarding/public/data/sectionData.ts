...
const faqData: IFaqData[] = [
  ...
  const navbarImages: string[] = [
    "url('/assets/images/defocused-reception.jpg')",
    "url('/assets/images/elegant-restaurant-with-wooden-tables.jpg')",
    "url('/assets/images/faded-sun@3000x2000px.jpg')",
  ];
